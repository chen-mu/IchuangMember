...
import { PAGE_MATCH_DETAIL } from '@constants/page'
...
class matchItem extends BaseComponent {
        ...
        <Board className='p-1' >
          <View className='at-row at-row__justify--between' onClick={this.onNavDetail.bind(this, item.id)}>
            <View>
              ...
              <View className='ml-2 text-normal mt-2 '  style='overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:80vw'> {item.introduction} </View>
